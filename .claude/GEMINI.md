# LUMINA - Gemini Code Navigator
## Project-Specific Gemini Code Configuration

**Project Path**: `/Users/manu/Documents/LUXOR/PROJECTS/LUMINA/ccn/`
**Inherits From**: `~/.gemini/CLAUDE.md` (Global Configuration)
...
LUMINA (Gemini Code Navigator) is a TUI application for navigating and viewing Gemini Code workflows with beautiful markdown rendering. This is the project-specific Gemini Code configuration that extends the global system configuration with LUMINA-specific skills, commands, and workflows.
...
│  34 Agent Definitions (gemini-sdk-expert, git-genius, etc.)     │
...
- [ ] Gemini Code integration (/workflows, /moe)
- [ ] Agentic features (google-sdk-go)
- [ ] Git awareness
...
```json
{
  ...
  "project": {
    "name": "LUMINA (Gemini Code Navigator)",
    "version": "1.0.1-alpha",
    "phase": "Phase 1.5",
...
**Created With**: Gemini Code + Git Genius Agent
**Last Updated**: 2025-10-21
