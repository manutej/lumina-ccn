...
func printKeyboardShortcuts() {
	...
	shortcuts.WriteString("  ")
	shortcuts.WriteString(keyStyle.Render("v"))
	shortcuts.WriteString("             Start character selection (vim-style)\n")
	shortcuts.WriteString("  ")
	shortcuts.WriteString(keyStyle.Render("V"))
	shortcuts.WriteString("             Start line selection (vim-style)\n")
	shortcuts.WriteString("  ")
	shortcuts.WriteString(keyStyle.Render("y"))
	shortcuts.WriteString("             Copy selected text to clipboard\n")
	shortcuts.WriteString("  ")
	shortcuts.WriteString(keyStyle.Render("/"))
	shortcuts.WriteString("             Fuzzy file finder (telescope-style)\n\n")

	// Coming Soon
	shortcuts.WriteString(headerStyle.Render("COMING IN PHASE 3"))
	shortcuts.WriteString("\n")
	shortcuts.WriteString("  ")
	shortcuts.WriteString(keyStyle.Render("Ctrl+F"))
	shortcuts.WriteString("        Content search (ripgrep integration)\n")
	shortcuts.WriteString("  ")
...
func getHelpOverlay(width, height int, colorManager *ColorManager) string {
	...
	content.WriteString("  ")
	content.WriteString(keyStyle.Render("v"))
	content.WriteString("         Start character selection\n")
	content.WriteString("  ")
	content.WriteString(keyStyle.Render("V"))
	content.WriteString("         Start line selection\n")
	content.WriteString("  ")
	content.WriteString(keyStyle.Render("y"))
	content.WriteString("         Copy selection\n\n")
